...
var o9071 = temp__5751__auto__;
var temp__5751__auto____$1 = (o9071["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o9072 = temp__5751__auto____$1;
return (o9072["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8398__auto__ = f;
return (o__8398__auto__["toString"]).call(o__8398__auto__);
} else {
return "";
}
}catch (e9073){var _ = e9073;
return "";
}});
...
try{var o__8398__auto___9075 = t;
(o__8398__auto___9075["cljs$lang$ctorPrWriter"]).call(o__8398__auto___9075,t,writer);
}catch (e9074){var __9076 = e9074;
}
...
var char_code = (function (){var o__8398__auto__ = (new String(char$));
return (o__8398__auto__["charCodeAt"]).call(o__8398__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8398__auto__ = String;
return (o__8398__auto__["fromCharCode"]).call(o__8398__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9077 = num_code;
switch (G__9077) {
case (1):
return (185);
...
var o__8398__auto__ = String;
return (o__8398__auto__["fromCharCode"]).call(o__8398__auto__,superscript_code);
});
/**
...
}catch (e9079){var _e__8405__auto__ = e9079;
return false;
}})())){
...
var vec__9080 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9080,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9085){
var vec__9086 = p__9085;
var ns_detector = cljs.core.nth.call(null,vec__9086,(0),null);
...
var G__9092 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9093 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9092;
remaining_tokens = G__9093;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9083){
var G__9084 = cljs.core.first.call(null,seq9083);
var seq9083__$1 = cljs.core.next.call(null,seq9083);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9084,seq9083__$1);
}));
...
var vec__9097 = cljs.core.split_with.call(null,(function (p1__9096_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9096_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9097,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9097,(1),null);
...
var vec__9103 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9103,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9103,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9106 = cljs.core.rest.call(null,remaining_tokens);
var G__9107 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9106;
name_tokens = G__9107;
continue;
} else {
...
var vec__9110 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9110,(0),null);
var arity = cljs.core.nth.call(null,vec__9110,(1),null);
var vec__9113 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9113,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9113,(1),null);
var vec__9116 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9116,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9116,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9116,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9116,(3),null);
...
var vec__9122 = result;
var munged_ns = cljs.core.nth.call(null,vec__9122,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9122,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9122,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9122,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9122,(4),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__9126 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__9126,(0),null);
var args = cljs.core.nth.call(null,vec__9126,(1),null);
var vec__9129 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__9132 = (arity + (1));
var G__9133 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9134){
var vec__9135 = p__9134;
var arity = cljs.core.nth.call(null,vec__9135,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9135,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9138_SHARP_){
return cljs.core.get.call(null,arities,p1__9138_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__9139_SHARP_){
return cljs.core.drop.call(null,(2),p1__9139_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9142){
var vec__9143 = p__9142;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9143,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9140){
var G__9141 = cljs.core.first.call(null,seq9140);
var seq9140__$1 = cljs.core.next.call(null,seq9140);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9141,seq9140__$1);
}));
...
var map__9151 = options;
var map__9151__$1 = (((((!((map__9151 == null))))?(((((map__9151.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9151.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9151):map__9151);
var include_ns_QMARK_ = cljs.core.get.call(null,map__9151__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9151__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9151__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9151__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9152 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9152,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9152,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9152,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9152,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9152,(4),null);
var arity = cljs.core.nth.call(null,vec__9152,(5),null);
...
var o__8398__auto__ = f;
return (o__8398__auto__["getBasis"]).call(o__8398__auto__);
});
/**
...
}catch (e9156){var _e__8405__auto__ = e9156;
...
var G__9157 = (obj[cljs.core.first.call(null,path)]);
var G__9158 = cljs.core.rest.call(null,path);
obj = G__9157;
path = G__9158;
continue;
} else {
...
var _STAR_ = (function (accum,p__9159){
var vec__9160 = p__9159;
var bit = cljs.core.nth.call(null,vec__9160,(0),null);
var protocol = cljs.core.nth.call(null,vec__9160,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9163){
var vec__9164 = p__9163;
var ns = cljs.core.nth.call(null,vec__9164,(0),null);
var name = cljs.core.nth.call(null,vec__9164,(1),null);
var selector = cljs.core.nth.call(null,vec__9164,(2),null);
...
var post_process = (function (p__9168){
var vec__9169 = p__9168;
var munged_name = cljs.core.nth.call(null,vec__9169,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9169,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9167_SHARP_){
return (obj[cljs.core.first.call(null,p1__9167_SHARP_)]);
}),sorted_matches);
