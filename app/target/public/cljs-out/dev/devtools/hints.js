...
var file = cljs.core.get.call(null,map__11735__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11735__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
}catch (e11734){var _e = e11734;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___11737 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___11737)){
var seen_errors_11738 = temp__5751__auto___11737;
if(cljs.core.truth_(seen_errors_11738.has(self))){
} else {
seen_errors_11738.add(self);

var temp__5753__auto___11739 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___11739)){
var sense_11740 = temp__5753__auto___11739;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11740)].join(''));
} else {
}
}
} else {
