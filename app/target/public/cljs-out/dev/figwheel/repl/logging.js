...
var c_11081 = (new goog.debug.Console());
var G__11080_11082 = c_11081.getFormatter();
goog.object.set(G__11080_11082,"showAbsoluteTime",false);

goog.object.set(G__11080_11082,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_11081);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__11083_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__11083_SHARP_);
