...
var c_8384 = (new goog.debug.Console());
var G__8383_8385 = c_8384.getFormatter();
goog.object.set(G__8383_8385,"showAbsoluteTime",false);

goog.object.set(G__8383_8385,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_8384);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__8386_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__8386_SHARP_);
