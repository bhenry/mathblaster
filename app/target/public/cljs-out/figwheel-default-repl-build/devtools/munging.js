...
var o9261 = temp__5751__auto__;
var temp__5751__auto____$1 = (o9261["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o9262 = temp__5751__auto____$1;
return (o9262["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8619__auto__ = f;
return (o__8619__auto__["toString"]).call(o__8619__auto__);
} else {
return "";
}
}catch (e9263){var _ = e9263;
return "";
}});
...
try{var o__8619__auto___9265 = t;
(o__8619__auto___9265["cljs$lang$ctorPrWriter"]).call(o__8619__auto___9265,t,writer);
}catch (e9264){var __9266 = e9264;
}
...
var char_code = (function (){var o__8619__auto__ = (new String(char$));
return (o__8619__auto__["charCodeAt"]).call(o__8619__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8619__auto__ = String;
return (o__8619__auto__["fromCharCode"]).call(o__8619__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9267 = num_code;
switch (G__9267) {
case (1):
return (185);
...
var o__8619__auto__ = String;
return (o__8619__auto__["fromCharCode"]).call(o__8619__auto__,superscript_code);
});
/**
...
}catch (e9269){var _e__8626__auto__ = e9269;
return false;
}})())){
...
var vec__9270 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9270,(0),null);
...
var len__4736__auto___9279 = arguments.length;
var i__4737__auto___9280 = (0);
while(true){
if((i__4737__auto___9280 < len__4736__auto___9279)){
args__4742__auto__.push((arguments[i__4737__auto___9280]));

var G__9281 = (i__4737__auto___9280 + (1));
i__4737__auto___9280 = G__9281;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9275){
var vec__9276 = p__9275;
var ns_detector = cljs.core.nth.call(null,vec__9276,(0),null);
...
var G__9282 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9283 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9282;
remaining_tokens = G__9283;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9273){
var G__9274 = cljs.core.first.call(null,seq9273);
var seq9273__$1 = cljs.core.next.call(null,seq9273);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9274,seq9273__$1);
}));
...
var vec__9287 = cljs.core.split_with.call(null,(function (p1__9286_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9286_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9287,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9287,(1),null);
...
var vec__9293 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9293,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9293,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9296 = cljs.core.rest.call(null,remaining_tokens);
var G__9297 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9296;
name_tokens = G__9297;
continue;
} else {
...
var vec__9300 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9300,(0),null);
var arity = cljs.core.nth.call(null,vec__9300,(1),null);
var vec__9303 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9303,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9303,(1),null);
var vec__9306 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9306,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9306,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9306,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9306,(3),null);
...
var vec__9312 = result;
var munged_ns = cljs.core.nth.call(null,vec__9312,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9312,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9312,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9312,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9312,(4),null);
var arity = cljs.core.nth.call(null,vec__9312,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__9316 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__9316,(0),null);
var args = cljs.core.nth.call(null,vec__9316,(1),null);
var vec__9319 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9319,(0),null);
var name = cljs.core.nth.call(null,vec__9319,(1),null);
...
var G__9322 = (arity + (1));
var G__9323 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9324){
var vec__9325 = p__9324;
var arity = cljs.core.nth.call(null,vec__9325,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9325,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9328_SHARP_){
return cljs.core.get.call(null,arities,p1__9328_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__9329_SHARP_){
return cljs.core.drop.call(null,(2),p1__9329_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___9336 = arguments.length;
var i__4737__auto___9337 = (0);
while(true){
if((i__4737__auto___9337 < len__4736__auto___9336)){
args__4742__auto__.push((arguments[i__4737__auto___9337]));

var G__9338 = (i__4737__auto___9337 + (1));
i__4737__auto___9337 = G__9338;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9332){
var vec__9333 = p__9332;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9333,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9330){
var G__9331 = cljs.core.first.call(null,seq9330);
var seq9330__$1 = cljs.core.next.call(null,seq9330);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9331,seq9330__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__9341__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9341__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9341__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9341__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9342 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9342,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9342,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9342,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9342,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9342,(4),null);
var arity = cljs.core.nth.call(null,vec__9342,(5),null);
...
var o__8619__auto__ = f;
return (o__8619__auto__["getBasis"]).call(o__8619__auto__);
});
/**
...
}catch (e9346){var _e__8626__auto__ = e9346;
...
var G__9347 = (obj[cljs.core.first.call(null,path)]);
var G__9348 = cljs.core.rest.call(null,path);
obj = G__9347;
path = G__9348;
continue;
} else {
...
var _STAR_ = (function (accum,p__9349){
var vec__9350 = p__9349;
var bit = cljs.core.nth.call(null,vec__9350,(0),null);
var protocol = cljs.core.nth.call(null,vec__9350,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9353){
var vec__9354 = p__9353;
var ns = cljs.core.nth.call(null,vec__9354,(0),null);
var name = cljs.core.nth.call(null,vec__9354,(1),null);
var selector = cljs.core.nth.call(null,vec__9354,(2),null);
...
var post_process = (function (p__9358){
var vec__9359 = p__9358;
var munged_name = cljs.core.nth.call(null,vec__9359,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9359,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__9357_SHARP_){
return (obj[cljs.core.first.call(null,p1__9357_SHARP_)]);
}),sorted_matches);
