...
var G__9364 = devtools.prefs.pref.call(null,v);
v = G__9364;
continue;
} else {
return v;
...
}catch (e9367){var _e__8626__auto__ = e9367;
return false;
}})();
...
}catch (e9371){var _e__8626__auto__ = e9371;
return false;
}})();
...
}catch (e9373){var _e__8626__auto__ = e9373;
return false;
}}
}
});
...
var vec__9375 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9375,(0),null);
var name = cljs.core.nth.call(null,vec__9375,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9378_SHARP_);
}),template);
});
