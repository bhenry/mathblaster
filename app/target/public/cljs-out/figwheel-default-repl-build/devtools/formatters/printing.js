...
var len__4736__auto___9397 = arguments.length;
var i__4737__auto___9398 = (0);
while(true){
if((i__4737__auto___9398 < len__4736__auto___9397)){
args__4742__auto__.push((arguments[i__4737__auto___9398]));

var G__9399 = (i__4737__auto___9398 + (1));
i__4737__auto___9398 = G__9399;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9394){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9395,G__9396,seq9394__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9400_SHARP_){
return (!((cljs.core.meta.call(null,p1__9400_SHARP_) == null)));
})))){
...
var map__9401 = opts;
var map__9401__$1 = (((((!((map__9401 == null))))?(((((map__9401.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9401.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9401):map__9401);
var markup_db = cljs.core.get.call(null,map__9401__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9405){var _e__8626__auto__ = e9405;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e9407){var _e__8626__auto__ = e9407;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9409 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9410 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9410);
...
var markup_db = cljs.core.get.call(null,map__9411__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9409);
}});
...
var temp__5751__auto___9416 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___9416)){
var managed_print_level_9417 = temp__5751__auto___9416;
var _STAR_print_level_STAR__orig_val__9414_9418 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9415_9419 = managed_print_level_9417;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9415_9419);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__9413_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9413_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9414_9418);
}} else {
job_fn.call(null);
}
