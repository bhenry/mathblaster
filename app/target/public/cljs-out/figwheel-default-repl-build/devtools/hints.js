...
var map__11554 = top_item;
var map__11554__$1 = (((((!((map__11554 == null))))?(((((map__11554.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11554.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11554):map__11554);
var file = cljs.core.get.call(null,map__11554__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11554__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11554__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e11553){var _e = e11553;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___11556 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___11556)){
var seen_errors_11557 = temp__5751__auto___11556;
if(cljs.core.truth_(seen_errors_11557.has(self))){
} else {
seen_errors_11557.add(self);

var temp__5753__auto___11558 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___11558)){
var sense_11559 = temp__5753__auto___11558;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11559)].join(''));
} else {
}
}
} else {
